            ...
            <Grid container spacing={1}>
              <Grid item xs={12} sm={6}>
                <FormControl variant="outlined" className={classes.formControl} error={error?.type}>
                  <InputLabel id="type-label">اختر تصنيف</InputLabel>
                  <Select
                    labelId="type-label"
                    id="type"
                    value={state.type}
                    ...
                    label="Select Type"
                  >
                    <MenuItem value="free">مجانى</MenuItem>
              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  <InputLabel htmlFor="markdown">رابط الوصف التفصيلي</InputLabel>
                  <OutlinedInput
                    id="markdown"
              ...
              <Grid item xs={12} sm={6}>
                <FormControl className={classes.formControl} variant="outlined" error={error?.quiz}>
                  <InputLabel htmlFor="quiz">رابط التمرين</InputLabel>
                  <OutlinedInput
                    id="quiz"
                    value={state.quiz}
              ...
              <Grid item xs={12} sm={6}>
                <FormControl className={classes.formControl} variant="outlined" error={error?.exam}>
                  <InputLabel htmlFor="exam">رابط الامتحان</InputLabel>
                  <OutlinedInput
                    id="exam"
                    value={state.exam}
              ...
              <Grid item xs={12} sm={6}>
                <Button
                  ...
                  fullWidth
                >
                  {state.id === '' ? 'إضافة الدرس الجديد' : 'قم بتحديث الدرس'}
                </Button>
              </Grid>
            </Grid>
          </form>
