            ...
            <Grid container spacing={1}>
              ...
              <Grid item xs={12}>
                <FormControl
                  ...
                  error={error?.video}
                >
                  <InputLabel htmlFor="video">رابط الفيديو</InputLabel>
                  <OutlinedInput
                    id="video"
                    value={state.video}
              ...
              <Grid item xs={10} sm={5}>
                <FormControl className={classes.formControl} variant="outlined">
                  <InputLabel htmlFor="resource-link">رقم الدورة</InputLabel>
                  <OutlinedInput
                    id="node-id"
                    value={resource.uri}
              ...
              <Grid item xs={10} sm={5}>
                <FormControl className={classes.formControl} variant="outlined">
                  <InputLabel htmlFor="resource-link">رقم الامتحان</InputLabel>
                  <OutlinedInput
                    id="node-id"
                    value={resource.uri}
                    onChange={(e) => setResource({ ...resource, uri: e.target.value })}
              ...
              <Grid item xs={10} sm={5}>
                <FormControl className={classes.formControl} variant="outlined">
                  <InputLabel htmlFor="resource-link">رقم المشروع</InputLabel>
                  <OutlinedInput
                    id="node-id"
                    value={resource.uri}
                    onChange={(e) => setResource({ ...resource, uri: e.target.value })}
              ...
              <Grid item xs={10} sm={5}>
                <FormControl className={classes.formControl} variant="outlined">
                  <InputLabel htmlFor="resource-link">رقم الواجب</InputLabel>
                  <OutlinedInput
                    id="node-id"
                    value={resource.uri}
                    onChange={(e) => setResource({ ...resource, uri: e.target.value })}
              ...
              <Grid item xs={10} sm={5}>
                <FormControl className={classes.formControl} variant="outlined">
                  <InputLabel htmlFor="resource-link">رابط المصادر</InputLabel>
                  <OutlinedInput
                    id="resource-link"
                    value={resource.uri}
                    onChange={(e) => setResource({ ...resource, uri: e.target.value })}
              ...
              <Grid item xs={10} sm={5}>
                <FormControl className={classes.formControl} variant="outlined">
                  <InputLabel htmlFor="resource-link">تغطية الموضوع</InputLabel>
                  <OutlinedInput
                    id="resource-link"
                    value={resource.uri}
                    onChange={(e) => setResource({ ...resource, uri: e.target.value })}
              ...
              <Grid item xs={10} sm={5}>
                <FormControl className={classes.formControl} variant="outlined">
                  <InputLabel htmlFor="resource-link">متطلبات الدورة</InputLabel>
                  <OutlinedInput
                    id="resource-link"
                    value={resource.uri}
                    onChange={(e) => setResource({ ...resource, uri: e.target.value })}
              ...
              <Grid item xs={10} sm={5}>
                <FormControl className={classes.formControl} variant="outlined">
                  <InputLabel htmlFor="resource-link">دورات أخرى</InputLabel>
                  <OutlinedInput
                    id="resource-link"
                    value={resource.uri}
                    onChange={(e) => setResource({ ...resource, uri: e.target.value })}
              ...
              <Grid item xs={12} sm={6}>
                <Button
                  ...
                  fullWidth
                >
                  {state.id === '' ? 'إضافة الدورة الجديدة' : 'تحديث بيانات الدورة'}
                </Button>
              </Grid>
            </Grid>
          </form>
